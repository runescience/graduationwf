...
# Main record fields. NOTE: unique requestID maybe duplicating CASE_ID
UNIQUE_REQUEST_ID="WFREQ-20250714-002"
...
echo "Dummy CSIWF_Request record $UNIQUE_REQUEST_ID inserted successfully"